...
public class StudentRepoImpl : IStudentRepo
{
    ...
    public Student GetStudentById(int sid) => studentList.FirstOrDefault(s => s.Id == sid);

    public List<Student> GetAllStudents() => studentList;
    ...
    public void UpdateStudent(Student student)
    {
        var existingStudent = studentList.FirstOrDefault(s => s.Id == student.Id);
